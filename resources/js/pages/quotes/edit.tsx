...
export default function QuoteEdit({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Editar', href: route('quotes.edit', quote.id) },
    ];

    const initialItems: FormQuoteItem[] = (quote.items ?? []).map((item) => ({
    ...
    const { data, setData, put, processing, errors } = useForm<QuoteFormState>({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Editar ${quote.numero}`} />
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <HeadingSmall title={`Editar Cotización ${quote.numero}`} description="Modifica los datos de la cotización existente." />
                </div>
                        ...
                        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) => setData('client_site_id', val ? Number(val) : '')}
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) => setData('vehicle_id', val ? Number(val) : '')}
