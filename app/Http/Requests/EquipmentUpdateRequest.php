...
class EquipmentUpdateRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('equipment.update');
    }
    ...
    public function rules(): array
    {
        return [
            'vehicle_id' => [
                'nullable',
                'integer',
                Rule::exists('vehicles', 'id')->where(fn ($query) => $query->where('client_id', $this->route('equipment')->client_id)),
            ],
            ...
            'ultima_atencion' => ['nullable', 'date'],
            'proxima_atencion' => ['nullable', 'date'],
            'ultima_ph' => ['nullable', 'date'],
            'proxima_ph' => ['nullable', 'date'],
